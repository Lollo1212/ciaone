...
public class SwingMenu implements IMenu {
    ...
    public void friendRequest(String username) {
        ...
        connection.write((addfriend == JOptionPane.NO_OPTION ? ServerMessages.DeclineFriend : ServerMessages.AcceptFriend), username);
    }
    ...
    public void gameChallenge(String username) {
        ...
        connection.write((selected == JOptionPane.NO_OPTION ? ServerMessages.DeclineGame : ServerMessages.AcceptGame), username);
    }
    ...
    protected void changePassword() {
        ...
        if (option == JOptionPane.OK_OPTION) {
            if (input.length() > 3) {
                connection.write(ServerMessages.ChangePassword, input);
            } else {
